...
ActiveRecord::Schema.define(version: 20180214174600) do
  ...
  create_table "tour_details", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["bus_id"], name: "index_tour_details_on_bus_id"
    t.index ["driver_id"], name: "index_tour_details_on_driver_id"
    t.index ["package_id"], name: "index_tour_details_on_package_id"
  end
